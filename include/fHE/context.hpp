...
struct context {
  ...
  static constexpr size_t max_moduli_bits = 62 * 4;
  static constexpr size_t nr_ctxt_moduli = (max_moduli_bits + yell::params::kModulusBitsize - 1) / yell::params::kModulusBitsize;
